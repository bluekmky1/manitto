...
import { useNavigate, useActionData, useNavigation, useLoaderData, Form } from "@remix-run/react";
      ...
      <div className="max-w-2xl mx-auto bg-white min-h-screen flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 px-4 py-4 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h1 className="text-gray-900 text-lg font-medium ml-4">편지 쓰기</h1>
          </div>
        ...
        <div className="flex-1 flex flex-col px-4 ">
          <Form method="post" className="space-y-4">
            ...
            <button
              type="submit"
              disabled={!message.trim() || isSubmitting || message.length > 100}
          ...
          <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 mt-4">
            ...
            <ul className="text-sm text-indigo-800 space-y-1">
              ...
              <li>• 메시지는 100자까지만 쓸 수 있습니다</li>
              <li>• 따뜻하고 긍정적인 메시지로 상대방의 하루를 밝혀주세요</li>
            </ul>
          </div>
        </div>
      </div>
